...
class AdManager:
    ...
    def show_real_rewarded_ad(self):
        try:
            ...
            # Safe JNI Call to Android PythonActivity
            PythonActivity = autoclass('org.kivy.android.PythonActivity')
            currentActivity = PythonActivity.mActivity
            
            # Yahan Google AdMob SDK / Native Activity hook safe tarike se call ho sakta hai
        except Exception as e:
    ...
    def draw(self, screen):
        ...
        # APK aur Pydroid dono par fallback visual feedback chalega agar Ad load hone me time le
        ...
        title = self.F_BIG.render("AD REWARD", True, (0,230,255))
        ...
        count = self.F_MED.render(f"Closing in {int(remaining)+1}s", True, (255,255,255))
